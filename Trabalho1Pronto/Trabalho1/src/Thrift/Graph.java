...
public class Graph {
  ...
  public interface AsyncIface {
    ...
    public void addVertex(Vertex vertex, org.apache.thrift.async.AsyncMethodCallback<AsyncClient.addVertex_call> resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public void addVertex(Vertex vertex) throws org.apache.thrift.TException
    {
      send_addVertex(vertex);
      recv_addVertex();
    }

    public void send_addVertex(Vertex vertex) throws org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public void addVertex(Vertex vertex, org.apache.thrift.async.AsyncMethodCallback<addVertex_call> resultHandler) throws org.apache.thrift.TException {
      checkReady();
      addVertex_call method_call = new addVertex_call(vertex, resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }

    public static class addVertex_call extends org.apache.thrift.async.TAsyncMethodCall {
      private Vertex vertex;
      public addVertex_call(Vertex vertex, org.apache.thrift.async.AsyncMethodCallback<addVertex_call> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.vertex = vertex;
      }
      ...
      public void getResult() throws org.apache.thrift.TException {
        ...
        org.apache.thrift.transport.TMemoryInputTransport memoryTransport = new org.apache.thrift.transport.TMemoryInputTransport(getFrameBuffer().array());
        org.apache.thrift.protocol.TProtocol prot = client.getProtocolFactory().getProtocol(memoryTransport);
        (new Client(prot)).recv_addVertex();
      }
    }
...
;
  ...
  public static class addVertex_args implements org.apache.thrift.TBase<addVertex_args, addVertex_args._Fields>, java.io.Serializable, Cloneable   {
    ...
    private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
    static {
      schemes.put(StandardScheme.class, new addVertex_argsStandardSchemeFactory());
      schemes.put(TupleScheme.class, new addVertex_argsTupleSchemeFactory());
    }
    ...
    public addVertex_args setVertex(Vertex vertex) {
      this.vertex = vertex;
      return this;
    }
    ...
    public int compareTo(addVertex_args other) {
      ...
      int lastComparison = 0;
      addVertex_args typedOther = (addVertex_args)other;
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("addVertex_args(");
      boolean first = true;
    ...
    private static class addVertex_argsStandardSchemeFactory implements SchemeFactory {
      public addVertex_argsStandardScheme getScheme() {
        return new addVertex_argsStandardScheme();
      }
    }

    private static class addVertex_argsStandardScheme extends StandardScheme<addVertex_args> {
    ...
    private static class addVertex_argsTupleSchemeFactory implements SchemeFactory {
      public addVertex_argsTupleScheme getScheme() {
        return new addVertex_argsTupleScheme();
      }
    }

    private static class addVertex_argsTupleScheme extends TupleScheme<addVertex_args> {
  ...
  public static class addVertex_result implements org.apache.thrift.TBase<addVertex_result, addVertex_result._Fields>, java.io.Serializable, Cloneable   {
    ...
    private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
    static {
      schemes.put(StandardScheme.class, new addVertex_resultStandardSchemeFactory());
      schemes.put(TupleScheme.class, new addVertex_resultTupleSchemeFactory());
    }
...
;
    ...
    public int compareTo(addVertex_result other) {
      ...
      int lastComparison = 0;
      addVertex_result typedOther = (addVertex_result)other;
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("addVertex_result(");
      boolean first = true;
    ...
    private static class addVertex_resultStandardSchemeFactory implements SchemeFactory {
      public addVertex_resultStandardScheme getScheme() {
        return new addVertex_resultStandardScheme();
      }
    }

    private static class addVertex_resultStandardScheme extends StandardScheme<addVertex_result> {
    ...
    private static class addVertex_resultTupleSchemeFactory implements SchemeFactory {
      public addVertex_resultTupleScheme getScheme() {
        return new addVertex_resultTupleScheme();
      }
    }

    private static class addVertex_resultTupleScheme extends TupleScheme<addVertex_result> {
